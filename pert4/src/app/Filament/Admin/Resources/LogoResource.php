...
class LogoResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'heroicon-o-arrow-long-down';
    protected static ?string $navigationGroup = 'Setting';
    protected static ?string $navigationLabel = 'Logo Setting';
    protected static ?string $breadcrump = 'Logo Setting';
    protected static ?string $pluralLabel = 'Logo Config ';
